...
void GlobalButtons::render() {
    ...
    ImVec2 seedButtonsPos(
        contentRegionMin.x + 20,
        contentRegionMax.y - seedButtonsSize.y - 20);

    ImGui::SetCursorPos(seedButtonsPos);

    ImGui::BeginChild("SeedButtons", seedButtonsSize,
    ...
    ImVec2 exportButtonPos(
        contentRegionMax.x - exportButtonSize.x - 20,
        contentRegionMax.y - exportButtonSize.y - 20);

    ImGui::SetCursorPos(exportButtonPos);

    ImGui::BeginChild("ExportButton", exportButtonSize,
        ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar |
        ImGuiWindowFlags_NoScrollWithMouse |
        ImGuiWindowFlags_NoResize |
...
void GlobalButtons::renderGenerationButtons() {
    ...
    ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImGui::ColorConvertU32ToFloat4(ImGui::Spectrum::GRAY300()));
...
void GlobalButtons::renderExportButton() {
    // Export button
    ImGui::PushStyleColor(ImGuiCol_Button, ImGui::ColorConvertU32ToFloat4(ImGui::Spectrum::Static::GREEN500));
    ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImGui::ColorConvertU32ToFloat4(ImGui::Spectrum::Static::GREEN600));
    ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImGui::ColorConvertU32ToFloat4(ImGui::Spectrum::Static::GREEN400));
