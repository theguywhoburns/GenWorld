...
namespace Utils {
    class MeshExporter {
    public:
        static void ExportMesh(const Mesh* mesh, const std::string& format, GLFWwindow* window = nullptr);
    private:
    ...
    public:
        ...
        static void ExportTerrainAsOBJWithDialog(const TerrainMesh& terrain, GLFWwindow* window = nullptr);
    ...
    public:
        static void ExportBlockMeshAsOBJ(const BlockMesh& blockMesh, const std::string& filename);
        static void ExportBlockMeshAsOBJWithDialog(const BlockMesh& blockMesh, GLFWwindow* window = nullptr);
    ...
    private:
        ...
        static aiMesh* ConvertMeshDataToAssimp(MeshData* data, aiScene* scene, const std::string& texturePath, const std::string& outputDir);
        static aiNode* CreateNodeWithMesh(aiScene* scene, const std::string& nodeName, aiMesh* mesh);
        static aiScene* CreateSceneFromBlockMesh(const BlockMesh& blockMesh, const std::string& outputDir);
        static void AddChildNode(aiNode* parent, aiNode* child);
    };
