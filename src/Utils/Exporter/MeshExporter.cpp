...
void Utils::MeshExporter::ExportMesh(const Mesh* mesh, const std::string& format, GLFWwindow* window) {
    if (format == "obj") {
...
void Utils::MeshExporter::ExportMeshAsObj(const Mesh* mesh, GLFWwindow* window) {
